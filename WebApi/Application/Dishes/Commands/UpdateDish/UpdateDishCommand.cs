...
namespace Application.Dishes.Commands.UpdateDish
{
	...
	public class UpdateDishCommand : IRequest<DishUpdating>
	{
		public int Id { get; set; }
		public UpdateDishDto Dto { get; set; }
	}

	public class UpdateDishCommandHandler : IRequestHandler<UpdateDishCommand, DishUpdating>
	{
		...
		public async Task<DishUpdating> Handle(UpdateDishCommand request, CancellationToken cancellationToken)
		{
            ...
            var dishUpdating = new DishUpdating()
            {
                Id = updatedDish.Id,
                DishName = updatedDish.DishName,
                DishPrice = updatedDish.DishPrice,
                DishDescription = updatedDish.DishDescription,
                DishStatusId = updatedDish.DishStatusId,
                DishStatusName = updatedDish.DishStatus.DishStatusName,
                DishCategoryId = updatedDish.DishCategoryId,
                DishCategoryName = updatedDish.DishCategory.DishCategoryName
            };
